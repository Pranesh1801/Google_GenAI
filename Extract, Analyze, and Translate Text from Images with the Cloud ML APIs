...
```cmd
gcloud alpha services api-keys create --display-name="Pranesh_Trial" 
KEY_NAME=$(gcloud alpha services api-keys list --format="value(name)" --filter "displayName=Pranesh_Trial")
